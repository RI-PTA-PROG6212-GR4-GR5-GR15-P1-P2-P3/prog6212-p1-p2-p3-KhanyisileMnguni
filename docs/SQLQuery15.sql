...
('James Bond', 'james@gmail.com', 'hashed_pw_4', '1988-12-03', '063 023 4589');
...
(1,'Heritage Charity Walk','2026-09-25','Pretoria,Gauteng','Charity walk raising funds for local schools.'),
(2,'Cape Coastal Cycle Challenge','2026-11-12','Cape Twon, Western CApe','A scenic cyclying event along the Cape coastline.');

insert into Category(EventID,CategoryName,DistanceKM,MaxParticipants,EntryFee) values
(1,'5km Fun Run',5.00,300,100.00),
(1,'10km Road Race', 10.00,200,150.00),
